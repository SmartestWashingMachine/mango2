...
const BOX_USE_CASES: BoxUseCase[] = [
  ...
  {
    title: "4 boxes (1 transparent) (1 following) (1 system UI)",
    description:
      '"I want three boxes that each reads text on the screen with their own buttons, and sends the results to a fourth box (with a transparent background) wherever I place it. The second box follows the cursor around when I press "F" and can be hidden with "T". The third box should translate each line individually."',
    options: [
      { ...getOpts("Scout Receiver Transparent"), boxId: "READER" },
      {
        ...getOpts("Scout Sender"),
